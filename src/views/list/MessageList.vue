...
<!--    <el-button @click="showDialog2=true">添加用户</el-button>-->
    ...
    <el-table
      ...
      style="width: 100%">
      <el-table-column
        fixed prop="id" label="留言编号" width="220">
      </el-table-column>
      <el-table-column
        fixed prop="user_id" label="用户编号" width="170">
      </el-table-column>
      <el-table-column
        fixed prop="content" label="留言内容" width="150">
      </el-table-column>
      <el-table-column
        fixed prop="create_time" label="留言创建时间" width="150">
      </el-table-column>
      <el-table-column
        fixed prop="update_time" label="留言修改时间" width="150">
      </el-table-column>
      <el-table-column
        fixed prop="deleted" label="有效状态" width="150">
      </el-table-column>
      <el-table-column
        fixed prop="comment" label="备注" width="120">
      </el-table-column>
      <!--
      <el-table-column
                ...
                tableData: [
                    {
                        'id':'1',
                        'user_id': '2345',
                        'content': '合肥滨湖正荣府涉嫌内部腐败欺诈业主',
                        'create_time': '2021年3月31日',
                        'update_time': '2021年3月31日',
                        'deleted': '有效',
                        'comment': '',
                    },
                    {
                        'id':'2',
                        'user_id': '34323',
                        'content': 'HPV疫苗不公开透明事件反映',
                        'create_time': '2021年5月3日',
                        'update_time': '2021年5月3日',
                        'deleted': '有效',
                        'comment': '',
                    },
                    {
                        'id':'3',
                        'user_id': '5325398',
                        'content': '合肥东部新中心与小庙运河新城发展定位咨询',
                        'create_time': '2021年4月1日',
                        'update_time': '2021年4月1日',
                        'deleted': '有效',
                        'comment': '',
                    },
                    {
                        'id':'4',
                        'user_id': '53223467',
                        'content': '合肥地铁第四轮规划什么时候出来',
                        'create_time': '2021年5月16日',
                        'update_time': '2021年5月16日',
                        'deleted': '有效',
                        'comment': '',
                    },
                    {
